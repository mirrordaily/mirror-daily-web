...
const documents = {
  ...
  'query GetExternalById($id: ID!) {\n  external(where: {id: $id}) {\n    id\n    title\n    thumb\n    publishedDate\n    brief\n    content\n    tags {\n      name\n      slug\n    }\n    partner {\n      name\n      slug\n    }\n  }\n}\n\nquery GetRelatedPostsByExternalId($id: ID!) {\n  external(where: {id: $id}) {\n    relateds {\n      ...RelatedPost\n    }\n  }\n}\n\nquery GetExternalsByPartnerSlug($skip: Int!, $take: Int!, $slug: String!, $withAmount: Boolean! = false) {\n  externals(\n    skip: $skip\n    take: $take\n    where: {partner: {slug: {equals: $slug}}}\n    orderBy: {publishedDate: desc}\n  ) {\n    id\n    title\n    brief\n    publishedDate\n    thumb\n  }\n  externalsCount(where: {partner: {slug: {equals: $slug}}}) @include(if: $withAmount)\n}':
    types.GetExternalByIdDocument,
  'query GetFlashNews {\n  hots(take: 8, where: {state: {equals: "published"}}) {\n    outlink\n    hotnews {\n      id\n      title\n    }\n    hotexternal {\n      id\n      title\n    }\n  }\n}':
    types.GetFlashNewsDocument,
  'query GetPartnerInformation($slug: String!) {\n  partner(where: {slug: $slug}) {\n    name\n  }\n}':
    types.GetPartnerInformationDocument,
  'query GetPostsBySectionSlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByCategorySlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByAuthorId($skip: Int!, $take: Int!, $id: ID!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByTagSlug($skip: Int!, $take: Int!, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostById($id: ID!) {\n  post(where: {id: $id}) {\n    id\n    title\n    subtitle\n    heroCaption\n    publishedDate\n    heroImage {\n      ...ImageData\n    }\n    og_image {\n      ...ImageData\n    }\n    tags {\n      slug\n      name\n    }\n    tags_algo {\n      slug\n      name\n    }\n    sections {\n      name\n      color\n    }\n    writers {\n      id\n      name\n    }\n    photographers {\n      id\n      name\n    }\n    designers {\n      id\n      name\n    }\n    engineers {\n      id\n      name\n    }\n    apiData\n    apiDataBrief\n    Warning {\n      id\n      content\n    }\n    Warnings {\n      id\n      content\n    }\n    isAdult\n  }\n}\n\nquery GetRelatedPostsById($id: ID!) {\n  post(where: {id: $id}) {\n    relatedsInInputOrder {\n      ...RelatedPost\n    }\n  }\n}':
 ...
 */
export function gql(
  source: 'query GetFlashNews {\n  hots(take: 8, where: {state: {equals: "published"}}) {\n    outlink\n    hotnews {\n      id\n      title\n    }\n    hotexternal {\n      id\n      title\n    }\n  }\n}'
): (typeof documents)['query GetFlashNews {\n  hots(take: 8, where: {state: {equals: "published"}}) {\n    outlink\n    hotnews {\n      id\n      title\n    }\n    hotexternal {\n      id\n      title\n    }\n  }\n}']
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
 ...
 */
export function gql(
  source: 'query GetPostsBySectionSlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByCategorySlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByAuthorId($skip: Int!, $take: Int!, $id: ID!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByTagSlug($skip: Int!, $take: Int!, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostById($id: ID!) {\n  post(where: {id: $id}) {\n    id\n    title\n    subtitle\n    heroCaption\n    publishedDate\n    heroImage {\n      ...ImageData\n    }\n    og_image {\n      ...ImageData\n    }\n    tags {\n      slug\n      name\n    }\n    tags_algo {\n      slug\n      name\n    }\n    sections {\n      name\n      color\n    }\n    writers {\n      id\n      name\n    }\n    photographers {\n      id\n      name\n    }\n    designers {\n      id\n      name\n    }\n    engineers {\n      id\n      name\n    }\n    apiData\n    apiDataBrief\n    Warning {\n      id\n      content\n    }\n    Warnings {\n      id\n      content\n    }\n    isAdult\n  }\n}\n\nquery GetRelatedPostsById($id: ID!) {\n  post(where: {id: $id}) {\n    relatedsInInputOrder {\n      ...RelatedPost\n    }\n  }\n}'
): (typeof documents)['query GetPostsBySectionSlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, sections: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByCategorySlug($skip: Int!, $take: Int, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, categories: {some: {slug: {equals: $slug}}}}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByAuthorId($skip: Int!, $take: Int!, $id: ID!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{writers: {some: {id: {equals: $id}}}}, {photographers: {some: {id: {equals: $id}}}}, {designers: {some: {id: {equals: $id}}}}, {engineers: {some: {id: {equals: $id}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostsByTagSlug($skip: Int!, $take: Int!, $slug: String!, $withAmount: Boolean! = false) {\n  posts(\n    skip: $skip\n    take: $take\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n    orderBy: [{publishedDate: desc}]\n  ) {\n    sections {\n      name\n      color\n    }\n    ...PostOverview\n  }\n  postsCount(\n    where: {state: {equals: "published"}, OR: [{tags: {some: {slug: {equals: $slug}}}}, {tags_algo: {some: {slug: {equals: $slug}}}}]}\n  ) @include(if: $withAmount)\n}\n\nquery GetPostById($id: ID!) {\n  post(where: {id: $id}) {\n    id\n    title\n    subtitle\n    heroCaption\n    publishedDate\n    heroImage {\n      ...ImageData\n    }\n    og_image {\n      ...ImageData\n    }\n    tags {\n      slug\n      name\n    }\n    tags_algo {\n      slug\n      name\n    }\n    sections {\n      name\n      color\n    }\n    writers {\n      id\n      name\n    }\n    photographers {\n      id\n      name\n    }\n    designers {\n      id\n      name\n    }\n    engineers {\n      id\n      name\n    }\n    apiData\n    apiDataBrief\n    Warning {\n      id\n      content\n    }\n    Warnings {\n      id\n      content\n    }\n    isAdult\n  }\n}\n\nquery GetRelatedPostsById($id: ID!) {\n  post(where: {id: $id}) {\n    relatedsInInputOrder {\n      ...RelatedPost\n    }\n  }\n}']
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
