      ...
      {list.map((item) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="aspect-[375/208] w-full overflow-hidden md:aspect-[680/379] lg:aspect-[1127/628]">
                <CustomImage
