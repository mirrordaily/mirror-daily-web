    ...
    <div className="relative">
      <Swiper
        ...
        pagination={{
          ...
          bulletClass: `homepage-editor-choice-bullet ${homepageGtmEvents.editorChoiceButton}`,
        ...
        navigation={{
          nextEl: '.custom-swiper-navigation-next',
          prevEl: '.custom-swiper-navigation-prev',
        }}
        slidesPerView={1}
        autoplay={{
          delay: 5000,
