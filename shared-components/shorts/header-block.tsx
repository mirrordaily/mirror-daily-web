...
export default function HeaderBlock() {
  ...
  return (
    <div className="relative hidden w-full md:flex">
      <a
        href="/"
        className={`${shortsGtmEvents.logo} relative my-5 ml-5 h-[58px] w-[200px] lg:my-6 lg:h-[60px] lg:w-[208px]`}
      >
      ...
      <button
        className={`${shortsGtmEvents.creativityButton} my-[34px] ml-3 mr-7 h-7 shrink-0 rounded-[29px] bg-[#FF5A36] px-[10px] py-[3px] text-[15px] font-normal leading-[22px] text-white shadow-[2px_2px_4px_0px_rgba(0,0,0,0.25)] hover:bg-[#FF9078] active:bg-[#E54B29] ${
